          ...
          <div className="space-y-4">
            {CONTACTS.map((c) => (
              <a
                ...
                className="flex items-center gap-4 rounded-2xl border border-[#FFFFFF]/12 bg-[#0f1b2e] p-5 transition hover:border-[#16785F]/35 hover:bg-[#16243c]"
              >
            ...
            <div className="rounded-2xl border border-[#FFFFFF]/12 bg-[#0f1b2e] p-5">
              <div className="flex items-center gap-2.5 text-[#FFFFFF]">
                <Clock size={18} className="text-[#16785F]" />
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label className="mb-1.5 block text-sm font-medium text-[#FFFFFF]/80">Nume</label>
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-[#FFFFFF]/80">Mesaj</label>
